...
<?php
$items = array();
$items['title'] = __d(__EMPLOYMENT_LOCALE, 'add_employment');
$items['link'] = array('title' => __d(__EMPLOYMENT_LOCALE, 'employment_list'), 'url' => __SITE_URL . 'admin/product/links/index');
