...
class BlogsController extends BlogAppController
{
	...
	function last()
	{
		...
		$this->set('title_for_layout', __d(__BLOG_LOCALE, 'weblog') );
		$this->set('description_for_layout', __d(__BLOG_LOCALE, 'weblog' . ',' . __('site_description')));
		$this->set('keywords_for_layout', __d(__BLOG_LOCALE, 'weblog') . ',' . __('site_keywords'));
