...
<?php
$items = array();
$items['title'] = __d(__HONOR_LOCALE,'add_honor');
$items['link'] = array('title'=>__d(__HONOR_LOCALE,'honor_list'),'url'  =>__SITE_URL.'admin/honor/honors/index');
			...
			<table id="expense_table" class="expense_table" cellspacing="0" cellpadding="0" width="500">
				...
				<tbody>
					<tr>
						...
						<td>
							<input type="text" class="form-control" name="data[Honorimage][title][]" id="title_no_01" maxlength="255"  />
						</td>
						<td>
							&nbsp;
						</td>
