...
class CmsComponent extends Component
{
	...
	*/
	...
	function openGraph($site_name, $type, $title, $description, $imageUrl, $imageAlt, $url, $locale, $twitterCard, $twitterSite, $twitterCreator)
	{
		return array(
			...
			"name='twitter:card'" => $twitterCard,
			"name='twitter:site'" => $twitterSite,
			"property='twitter:creator'" => $twitterCreator
		);
	}
}
?>
