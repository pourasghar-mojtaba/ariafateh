	...
	<body class="hold-transition skin-blue sidebar-mini">
		...
		<div class="wrapper">
					...
					<ul class="sidebar-menu">
						...
						<li class="treeview <?php if(in_array($this->request->params['controller'],$controllers)) echo 'active'; ?> ">
							...
							<ul class="treeview-menu">
								...
								<li <?php if($this->request->params['controller'] == 'pages' && $id ==3) echo 'class="active"'; ?>>
									<a href="<?php echo __SITE_URL.'admin/pages/edit/3' ?>">
										<i class="fa fa-circle-o">
										</i> <?php echo __('catalog'); ?>
									</a>
								</li>
			...
			<footer class="main-footer">
				...
				<strong>
					&copy; 2020
					<a href="https://picosite.ir/" target="_blank">
