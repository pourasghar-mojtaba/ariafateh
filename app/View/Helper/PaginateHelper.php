...
class PaginateHelper extends HtmlHelper {
  ...
  function with_hide($total_pages,$page,$limit=10,$targetpage,$targetparams=''){
		...
		if($lastpage > 1)
		{
			...
			// Previous
			if ($page > 1){
				$paginate.= "<li class='page-item arrow-item'><a href='$targetpage&page=$prev'><i class='fa-chevron-right fas'></i></a></li>";
			}else{
			...
			if ($lastpage < 7 + ($stages * 2))	// Not enough pages to breaking it up
			{
				...
				{
					if ($counter == $page){
						$paginate.= "<li class='page-item'><span class='page-link active'>$counter</span></li>";
					}else{
			...
			elseif($lastpage > 5 + ($stages * 2))	// Enough pages to hide a few&
			{
				...
				else
				{
					...
					// Next
			if ($page < $counter - 1){
				$paginate.= "<li class='page-item arrow-item'><a class='next page-link' href='$targetpage&page=$next'><i class='fa-chevron-left fas'></i></a></li>";
			}else{
