...
function blog_admin_menu($arg)
{
	...
	$active = NULL;
	if ($arg['request']->params['controller'] == 'blogs') $active = 'class="active"';
	echo "
				<li " . $active . " >
...
function blog_user_menu($arg)
{
	echo "<li class='nav-item'>
			<a class='nav-link' href='" . __SITE_URL . __BLOG . "/blogs/last'>" . __d(__BLOG_LOCALE, 'blog') . "</a>
		 </li>";
}
...
function last_blogs($arg)
{
	...
	//pr($blogs);
	echo "<a href='#' class='title-custom-shape'>" . __d(__BLOG_LOCALE, 'last_blogs') . "</a>
	...
	foreach ($blogs as $blog) {
		...
		echo "
				...
				<div class='last-news-row '>
					<div
						class='image-news-box col-lg-4 col-md-3 col-12 justify-content-md-start justify-content-center'>
						<a href='" . __SITE_URL . __BLOG . "/" . $blog['Blog']['slug'] . "'>
							<img src='" . __SITE_URL . __BLOG_IMAGE_URL .__UPLOAD_BLOG_THUMB. '/' . $blog['Blog']['image'] . "' alt='" . $blog['Blogtranslation']['title'] . "'>
						</a>
					</div>
					<div class='last-content-box col-lg-8 col-md-9 col-12'>
						<p class='last-news-text'>
						<a href='" . __SITE_URL . __BLOG . "/" . $blog['Blog']['slug'] . "'>" . $blog['Blogtranslation']['title'] . "</a></p>
					</div>
				</div>
